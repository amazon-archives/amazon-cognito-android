...
public class LambdaThrottledExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("LambdaThrottledException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        LambdaThrottledException e = (LambdaThrottledException)super.unmarshall(error);
        e.setErrorCode("LambdaThrottledException");
