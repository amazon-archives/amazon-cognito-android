...
public class InvalidLambdaFunctionOutputExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("InvalidLambdaFunctionOutputException");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        InvalidLambdaFunctionOutputException e = (InvalidLambdaFunctionOutputException)super.unmarshall(error);
